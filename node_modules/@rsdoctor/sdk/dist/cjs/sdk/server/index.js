...
class RsdoctorServer {
  ...
  get host() {
    const host = (0, import_utils.getLocalIpAddress)();
    return host;
  }
  get origin() {
  ...
  async bootstrap() {
    ...
    this.app.use(
      (0, import_sirv.default)(clientDistPath, {
        dev: true
      })
    );
  ...
  async openClientPage(...args) {
    ...
    const needEncodeURI = arguments[0] === import_types.Client.RsdoctorClientRoutes.BundleDiff;
